  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="absolute left-10 text-2xs tracking-widest uppercase opacity-0 group-hover:opacity-100 transition-opacity delay-200 whitespace-nowrap">
          Upload Rx
        </span>
      </Link>
      ...
      <span
        className="text-2xs tracking-[0.35em] uppercase text-black/30"
