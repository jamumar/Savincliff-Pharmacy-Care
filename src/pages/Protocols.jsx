    ...
    <div className="bg-white min-h-screen pt-40">
      ...
      <section className="px-6 md:px-12 mb-20 lg:mb-40">
        <div className="max-w-[1800px] mx-auto border-b border-black pb-12">
          <h1 className="sub-display-svz uppercase">REGULATION</h1>
          <p className="text-xs font-black tracking-[0.4em] text-black/40 mt-4 uppercase">CLINICAL COMPLIANCE NODES / AUDIT 2026</p>
        </div>
      </section>
      ...
      <section className="bg-black text-white py-40 px-6 md:px-12">
        <div className="max-w-[1800px] mx-auto">
          <p className="text-2xs font-black tracking-[0.4em] uppercase text-brand-teal mb-12">Verification Systems</p>
            ...
            {badges.map((b, i) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs font-bold uppercase tracking-widest text-white/40 leading-relaxed">{b.body}</p>
                </div>
        ...
        <div className="max-w-[1800px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-24">
            <div className="lg:col-span-4">
              ...
              <p className="text-xs font-bold uppercase tracking-widest text-black/40 leading-relaxed max-w-xs">
