  ...
  return (
    <div className="space-y-12 md:space-y-40">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 md:gap-12 border-b border-black pb-8 md:pb-16">
        ...
        <div className="hidden md:flex items-center gap-6 text-2xs font-black tracking-[0.4em] uppercase text-black/20 group hover:text-brand-teal transition-all cursor-default">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-24 items-start">
         ...
         <div className="lg:col-span-7 space-y-16">
            <div className="flex items-center justify-between">
               <h3 className="text-xs font-black uppercase tracking-[0.5em] text-black/30">Clinical History</h3>
                ...
                {MOCK_ORDERS.map(order => (
                    <Link key={order.id} to="/account/orders" className="flex items-center justify-between py-12 border-b border-black/10 hover:bg-[#FAFAFA] transition-all px-6 -mx-6 group relative overflow-hidden">
                        <div className="relative z-10">
                            <p className="text-2xs font-black uppercase tracking-widest text-black/20 mb-2">Ref: SN-00{order.id}</p>
                        ...
                        <div className="relative z-10 text-right flex items-center gap-10">
                            <div>
                                ...
                                <p className="text-2xs font-black uppercase tracking-widest text-brand-teal mt-1">{order.status}</p>
                            </div>
            ...
            <div className="pt-8">
               <Link to="/account/orders" className="group inline-flex items-center gap-8 text-xs font-black uppercase tracking-[0.4em] border-b border-black pb-4 hover:text-brand-teal hover:border-brand-teal transition-all duration-700">
         ...
         <div className="lg:col-span-5 bg-black text-white p-8 md:p-12 lg:p-24 relative overflow-hidden group min-h-[350px] md:min-h-[600px] flex flex-col justify-center shadow-2xl">
            ...
            <div className="relative z-10 space-y-16">
               ...
               <p className="text-2xs md:text-xs font-black uppercase leading-relaxed tracking-widest text-white/30 max-w-sm">
                   Bypass standard clinical queues and unlock industrial-grade pharmaceutical oversight. Total precision at every node.
               </p>
               <button className="bg-white text-black px-8 md:px-16 py-5 md:py-8 text-2xs md:text-xs font-black uppercase tracking-[0.2em] md:tracking-[0.4em] hover:bg-brand-teal hover:text-white transition-all duration-700 shadow-2xl">Enter Node</button>
            </div>
            
            <div className="absolute bottom-12 right-12 text-2xs font-black uppercase tracking-[0.4em] text-white/5 group-hover:text-white/10 transition-colors">
