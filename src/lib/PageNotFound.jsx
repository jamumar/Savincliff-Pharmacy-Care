...
export default function PageNotFound() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-white relative overflow-hidden">
            ...
            >
                <div>
                   <p className="text-2xs font-black tracking-[0.4em] uppercase text-brand-teal mb-4 flex items-center justify-center gap-2">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-xs font-bold uppercase tracking-widest leading-relaxed text-black/40 max-w-sm mx-auto">
                ...
                <div className="pt-8">
                    <Link 
                        to="/" 
                        className="inline-flex items-center gap-8 bg-black text-white px-20 py-8 text-xs font-black uppercase tracking-[0.3em] hover:bg-brand-teal transition-all duration-700"
                    >
                        <ArrowLeft className="w-4 h-4" /> Root Restart
                    </Link>
                </div>

                <p className="text-2xs font-black uppercase tracking-[0.4em] text-black/20">
